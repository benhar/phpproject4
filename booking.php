...
<html lang="en">
	<head>
		...
		<title>Booking | Auto e ticketing portal</title>
		<!-- ================ Favicon ===================== -->
	...
	<body>
		...
		<section class="login-area fix">
			<form action="server1.php" method="post" class="container" id="needs-validation" novalidate>
				<div class="card">
					<div class="card-header "><h3>Booking Auto / Ricshaw ...</h3></div>
					<div class="card-body">
						<div class="row justify-content-md-center">
							<div class="col-md-6 mb-3">
								<label for="validationCustom01">From : </label>
								<input type="text" name="start" class="form-control" id="validationCustom01" placeholder="" required>
							</div>
						</div>
						<div class="row justify-content-md-center">
							<div class="col-md-6 mb-3">
								<label for="validationCustom02">To : </label>
								<input type="text" name="stop" class="form-control" id="validationCustom02" placeholder=""  required>
							</div>
						</div>
						<div class="row justify-content-md-center">
							<div class="col-md-6 mb-3">
						...
						<div class="row justify-content-md-center">
							<div class="col-md-6 mb-3">
								<div class="form-group">
									...
									<select name="cost" class="form-control" id="exampleFormControlSelect2">
										<option> </option>
										<option> 5 tk</option>
										<option> 10 tk</option>
										<option> 15 tk</option>
						...
						<div class="row justify-content-md-center">
							<div class="col-md-6 mb-3">
								...
								<input type="date" name="date" class="form-control" id="validationCustom06" placeholder="mm/dd/yyyy" required>
							</div>
						</div>
						<div class="row justify-content-end">
							<div class="col-md-5 mb-3">
								<button name="request" class="btn btn-success" type="submit">Request Booking</button>
							</div>
						</div>
					</div>
				</div>
